...
%~dp0%INSTALLER% /acceptlicense /execmode=Service /S /installtasks=Collect,Inventory  /installtype=from-scratch /task-daily-modifier=7 /task-frequency=Daily /server="http://%Server%/glpi/plugins/fusioninventory/" /no-ssl-check /no-httpd /no-p2p /no-start-menu /runnow
